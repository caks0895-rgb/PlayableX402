import { n as GAME_IDS, r as GAME_ID_LIST } from "./types-B4Cm2iRZ.mjs";
import { n as TSS_SERVER_FUNCTION, t as createServerFn } from "./ssr.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/functions-ZBFUVB6p.js
...
var getCatalogFn = createServerFn({ method: "GET" }).handler(getCatalogFn_createServerFn_handler, async () => {
	const { listCatalog } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
	return listCatalog();
});
...
var listWalletsFn = createServerFn({ method: "GET" }).handler(listWalletsFn_createServerFn_handler, async () => {
	const { listWallets } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
	return listWallets();
});
...
var listMatchesFn = createServerFn({ method: "GET" }).handler(listMatchesFn_createServerFn_handler, async () => {
	const { listMatches, toPublic, recentTape, getHouseBots, listChallenges } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
	return {
		matches: (await listMatches()).map((m) => toPublic(m, void 0, { logTail: 3 })),
...
var getMatchFn = createServerFn({ method: "GET" }).validator((data) => data).handler(getMatchFn_createServerFn_handler, async ({ data }) => {
	const { getMatch, toPublic } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
	const { checkSecret } = await import("./pay.server-DcxlzbMU.mjs").then((n) => n.o);
	const match = await getMatch(data.id);
	if (!match) return { match: null };
	return { match: toPublic(match, data.agentId && data.secret && checkSecret(data.agentId, data.secret) ? data.agentId : void 0) };
});
...
var setHouseBotsFn = createServerFn({ method: "POST" }).validator((data) => data).handler(setHouseBotsFn_createServerFn_handler, async ({ data }) => {
	const { setHouseBots } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
...
var sweepDemoFn = createServerFn({ method: "POST" }).handler(sweepDemoFn_createServerFn_handler, async () => {
	const { sweepDemo } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
	return sweepDemo();
});
...
var getHouseBotsFn = createServerFn({ method: "GET" }).handler(getHouseBotsFn_createServerFn_handler, async () => {
	const { getHouseBots } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
...
var createWalletFn = createServerFn({ method: "POST" }).validator((data) => data).handler(createWalletFn_createServerFn_handler, async ({ data }) => {
	const { createWallet } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
...
var createMatchFn = createServerFn({ method: "POST" }).validator((data) => data).handler(createMatchFn_createServerFn_handler, async ({ data }) => {
	const { createMatch, toPublic } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
...
var joinMatchFn = createServerFn({ method: "POST" }).validator((data) => data).handler(joinMatchFn_createServerFn_handler, async ({ data }) => {
	const { joinMatch } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
	return joinMatch({
...
var addBotsFn = createServerFn({ method: "POST" }).validator((data) => data).handler(addBotsFn_createServerFn_handler, async ({ data }) => {
	const { addBots, toPublic } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
...
var submitActionFn = createServerFn({ method: "POST" }).validator((data) => data).handler(submitActionFn_createServerFn_handler, async ({ data }) => {
	const { submitAction } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
	return submitAction({
		matchId: data.matchId,
		walletId: data.walletId,
		secret: data.secret,
...
var createChallengeFn = createServerFn({ method: "POST" }).validator((data) => data).handler(createChallengeFn_createServerFn_handler, async ({ data }) => {
	const { createChallenge } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
	const paymentHeader = data.walletId && data.secret ? JSON.stringify({
		walletId: data.walletId,
		secret: data.secret
	}) : data.walletId;
...
var listChallengesFn = createServerFn({ method: "GET" }).handler(listChallengesFn_createServerFn_handler, async () => {
	const { listChallenges } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
...
var startChallengeFn = createServerFn({ method: "POST" }).validator((data) => data).handler(startChallengeFn_createServerFn_handler, async ({ data }) => {
	const { startChallenge } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
	return startChallenge(data);
});
var listReputationsFn_createServerFn_handler = createServerRpc({
	id: "6aab53cc9642904e17816eed7d3be30abeea5cd8045f3d1f665f815ae1399111",
	name: "listReputationsFn",
	filename: "src/lib/engine/functions.ts"
}, (opts) => listReputationsFn.__executeServer(opts));
var listReputationsFn = createServerFn({ method: "GET" }).handler(listReputationsFn_createServerFn_handler, async () => {
	const { listAllAgentReputations } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
	return { reputations: listAllAgentReputations() };
});
var getAgentReputationFn_createServerFn_handler = createServerRpc({
	id: "71159462ad180b8a4b32da220c4dc23d02e80e8b0e091c4f3af26220904f5763",
	name: "getAgentReputationFn",
	filename: "src/lib/engine/functions.ts"
}, (opts) => getAgentReputationFn.__executeServer(opts));
var getAgentReputationFn = createServerFn({ method: "GET" }).validator((data) => data).handler(getAgentReputationFn_createServerFn_handler, async ({ data }) => {
	const { getAgentReputationById } = await import("./store.server-Br6AbScb.mjs").then((n) => n.g);
	return { reputation: getAgentReputationById(data.id) };
});
//#endregion
export { addBotsFn_createServerFn_handler, createChallengeFn_createServerFn_handler, createMatchFn_createServerFn_handler, createWalletFn_createServerFn_handler, getAgentReputationFn_createServerFn_handler, getCatalogFn_createServerFn_handler, getHouseBotsFn_createServerFn_handler, getMatchFn_createServerFn_handler, joinMatchFn_createServerFn_handler, listChallengesFn_createServerFn_handler, listMatchesFn_createServerFn_handler, listReputationsFn_createServerFn_handler, listWalletsFn_createServerFn_handler, setHouseBotsFn_createServerFn_handler, startChallengeFn_createServerFn_handler, submitActionFn_createServerFn_handler, sweepDemoFn_createServerFn_handler };

...
import { a as PUBLIC_BASE, n as GAME_IDS, r as GAME_ID_LIST } from "./types-B4Cm2iRZ.mjs";
import { t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { b as cn, t as checkSecret, w as __exportAll } from "./pay.server-DcxlzbMU.mjs";
import { C as CATALOG, S as listAllAgentReputations, _ as submitAction, a as createWallet, b as toPublic, c as getWallet, d as listCatalog, f as listChallenges, h as startChallenge, i as createMatch, l as healthSnapshot, m as listWallets, n as addBots, o as getHouseBots, p as listMatches, r as createChallenge, s as getMatch, t as EngineError, u as joinMatch, v as tickFloor, x as getAgentReputationById, y as toChallenge } from "./store.server-Br6AbScb.mjs";
import { B as require_react, L as redirect, _ as Link, f as createRouter, g as createRootRoute, h as createFileRoute, l as Scripts, m as lazyRouteComponent, p as Outlet, u as HeadContent, v as useRouter } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as TSS_SERVER_FUNCTION, r as getServerFnById, t as createServerFn } from "./ssr.mjs";
import { r as Compass, t as TriangleAlert } from "../_libs/lucide-react.mjs";
import { t as require_jsx_dev_runtime } from "../_libs/react.mjs";
import { a as union, i as string, n as number, r as object, t as literal } from "../_libs/zod.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/functions-CIHgn9YX.js
...
createServerFn({ method: "GET" }).handler(createSsrRpc("9fccfa64ea97798038002e7b67faf1409a917547275d2e85ced97c1d91574aa1"));
...
createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("7e62bb7e60b8b04912325ad724f5c455bdffaaf567ad3217be2508f45e648a95"));
createServerFn({ method: "POST" }).handler(createSsrRpc("f45f7363946a7217acfbd598a9563de0a6c000bfa1fd0b7b60d886b43cbfc9f5"));
createServerFn({ method: "GET" }).handler(createSsrRpc("9a99b2bdd2cf82014802f65c41c06bae2e465815b9d2bcb35c5cc9740bc59075"));
createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("2e76225859200c4fa11f8e415a3b6eb63d19ac1b50b6ea06e01547a2a25d5a05"));
createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("8c20703b98b79424f4888350ce093ba04e5195c153d10f2e8f2a5c468cad9c40"));
createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("8a56fa9c3fe6405506fd7856a81623569ba4a2c38de214c02f433713ad66276f"));
createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("0e84655ebcf6689b412e96f191f7921420830efb4d551d6b41a48fe3b4fbdf86"));
createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("385a48debc614140844a001a725a98529d499d0316f8ccfd05448f7a53e1f3bb"));
createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("2038fd7f9fb67b161a85e54e291bfa4bed23a2c28efe8133d30cf0608592a85b"));
createServerFn({ method: "GET" }).handler(createSsrRpc("83d969aa2cca2b2fb289a4b7dd35e0ef29bb5f02674fbd0a7c17ad1248aaac37"));
createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("c63d50882d5c14bcf4293177566b0719b5000b06a46aebb1d3248788e57212da"));
var listReputationsFn = createServerFn({ method: "GET" }).handler(createSsrRpc("6aab53cc9642904e17816eed7d3be30abeea5cd8045f3d1f665f815ae1399111"));
createServerFn({ method: "GET" }).validator((data) => data).handler(createSsrRpc("71159462ad180b8a4b32da220c4dc23d02e80e8b0e091c4f3af26220904f5763"));
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-5T9u12T6.js
...
var _jsxFileName$2 = "/app/applet/src/lib/not-found-component.tsx";
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				className: "flex h-14 w-14 items-center justify-center rounded-2xl border border-border bg-surface text-pool",
				children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Compass, { className: "size-7" }, void 0, false, {
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", {
					...
					children: "The table or route you requested doesn't exist or may have expired."
				}, void 0, false, {
					fileName: _jsxFileName$2,
					lineNumber: 13,
					columnNumber: 9
...
var styles_default = "/assets/styles-C-tmct3G.css";
var _jsxFileName = "/app/applet/src/routes/__root.tsx";
var APP_NAME = "PlayableX402 — The AI Agent Proving Ground";
...
var Route$11 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Adversarial testing ground for AI trading agents. Test decision speed with HTTP 402 micro-tickets and build verified ERC-8004 track records on Base before live market deployment."
			},
			{
				name: "theme-color",
				content: "#0c0d0b"
...
var $$splitComponentImporter$5 = () => import("./routes-B2vMO3u7.mjs");
var Route$10 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./docs-T3yfkyaB.mjs");
var Route$9 = createFileRoute("/docs")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./floor-z1Lwc0Aw.mjs");
var Route$8 = createFileRoute("/floor")({
	loader: async () => {
		try {
			const [games, listed] = await Promise.all([getCatalogFn(), listMatchesFn()]);
			return {
				games,
...
var Route$7 = createFileRoute("/openapi.json")({ server: { handlers: {
	OPTIONS: async () => discoveryOptions(),
	GET: async ({ request }) => discoveryJson(request, "openapi")
} } });
var $$splitComponentImporter$2 = () => import("./reputation-DuIcYecL.mjs");
var Route$6 = createFileRoute("/reputation")({
	loader: async () => {
		return { reputations: (await listReputationsFn()).reputations };
	},
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./skill-C4kyOjzJ.mjs");
var Route$5 = createFileRoute("/skill")({
	beforeLoad: () => {
...
var $$splitComponentImporter = () => import("./watch._id-BU7Dxw_N.mjs");
var Route$2 = createFileRoute("/watch/$id")({
	loader: async ({ params }) => {
		try {
			const [got, games] = await Promise.all([getMatchFn({ data: { id: params.id } }), getCatalogFn()]);
			return {
				match: got.match,
				games
			};
...
var lastSweep = 0;
function sweep(now) {
	if (now - lastSweep < 3e4) return;
	lastSweep = now;
	if (buckets.size < 400) return;
	for (const [k, b] of buckets) if (now - b.ts > 6e4) buckets.delete(k);
}
...
function asAction(body) {
	return {
		...
		move: typeof body.move === "string" ? body.move : void 0,
		option: typeof body.option === "string" ? body.option : void 0,
		tape: Array.isArray(body.tape) ? body.tape.map((x) => String(x)) : void 0,
		value: typeof body.value === "number" ? body.value : typeof body.value === "string" ? Number(body.value) : void 0
	};
}
function tooMany(retryAfter = 1) {
...
function rateLimitRequest(method, parts, ip) {
	const head = parts[0] ?? "";
	...
	if (head === "wallets" && method === "POST" && parts.length === 1) {
		if (!allow(`wallet:${ip}`, .5, 16)) return tooMany(2);
	}
	if ((head === "matches" || head === "challenges") && method === "POST" && parts.length === 1) {
		if (!allow(`open:${ip}`, .4, 8)) return tooMany(3);
	}
...
async function handleV1(method, splat, request) {
	...
	const limited = rateLimitRequest(method, parts, clientKey(request));
	...
	try {
		...
		if (parts[0] === "challenges" && parts[1]) {
			...
			if (!rest && method === "GET") {
				...
				const authed = agentId && secret && checkSecret(agentId, secret) ? agentId : void 0;
				return corsJson({
					challenge: toChallenge(match),
					match: toPublic(match, authed)
				});
			}
			if (rest === "join" && method === "POST") {
				...
				const result = await joinMatch({
					matchId: id,
					walletId: typeof body.walletId === "string" ? body.walletId : void 0,
					secret: typeof body.secret === "string" ? body.secret : void 0,
					paymentHeader: paymentHeader(request),
					controller: "human"
				});
				if (result.paymentRequired) return corsJson({
		...
		if (parts.length === 1 && parts[0] === "reputation" && method === "GET") return corsJson({ reputations: listAllAgentReputations() });
		if (parts.length === 2 && parts[0] === "reputation" && method === "GET") {
			const rep = getAgentReputationById(parts[1]);
			if (!rep) return corsJson({ error: "Agent reputation profile not found" }, 404);
			return corsJson({ reputation: rep });
		}
		...
		if (parts.length === 1 && parts[0] === "matches" && method === "GET") return corsJson({ matches: (await listMatches()).map((m) => toPublic(m, void 0, { logTail: 3 })) });
		...
		if (parts[0] === "matches" && parts[1]) {
			...
			if (rest === "events" && method === "GET") {
				...
				return sseMatch(id, agentId && secret && checkSecret(agentId, secret) ? agentId : null);
			}
			if (rest === "join" && method === "POST") {
				const body = await readBody(request);
				const result = await joinMatch({
		...
		if (err instanceof EngineError) {
			if (err.status === 429) return new Response(JSON.stringify({
				error: err.message,
				retryAfter: 3
			}), {
				status: 429,
...
var FloorRoute = Route$8.update({
	id: "/floor",
	path: "/floor",
	getParentRoute: () => Route$11
});
var OpenapiDotjsonRoute = Route$7.update({
	id: "/openapi.json",
	path: "/openapi.json",
	getParentRoute: () => Route$11
});
var ReputationRoute = Route$6.update({
	id: "/reputation",
	path: "/reputation",
	getParentRoute: () => Route$11
});
...
//#endregion
export { skillMarkdown as a, getMatchFn as c, HOW_TO_PLAY as i, listMatchesFn as l, Route$2 as n, Route$8 as o, Route$6 as r, Button as s, router_exports as t };
